...
Last change: 2026/05/07-23:33:32.
...
本 repository の方法論的な前提については、`Preface-ja.md` を参照してください。

本プロジェクトは、紙の注釈書を単にデジタル化するものではありません。本文、word-gloss、逐語訳、自然訳、notes を分離して構造化し、読めるだけでなく検索・比較・計算できる古典注釈書を作ることを目指しています。
